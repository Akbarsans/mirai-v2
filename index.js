...
const { test } = require('./src/test')  //nambah fitur
...
const vcard = 'BEGIN:VCARD\n' //
            ...
            + 'FN: OWNER SANS\n' //
            + 'ORG:Creator mirai;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=6285890216240:+62-858-9021-6240\n' // NOMER HP LU
            + 'END:VCARD'
prefix = '.'
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `hey kak @${num.split('@')[0]} mirai Titip Gorengan Yah Btw Gausa Kembali Lagi... Kembali = kick 😋`
				let buffer = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buffer, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: 'sedang Memperoses🍥tunggu ngok!',
				asik: 'sedang Memperoses🍥tunggu ngok!',
				success: '✔️ Berhasil ✔️',
				levelon: '[ON] *Leveling Telah aktif Ayo Kak Naikan Lvl Mu dengan Cara Aktif di grup ini*',
				leveloff: '[OFF]  *Yahh Leveling Telah Di NonAktifkan T_T*',
				...
				only: {
					...
					premium: '[❗] YAHH.. PERINTAH INI KHUSUS USER *PREMIUM*, beli premium dulu kak ke owner' ,
					mod: '[❗] PERINTAH INI KHUSUS USER *MOD*',
					benned: 'Anda Ke Band Silahkan Hubungi Owner Agar Membuka Band Anda',
					ownerG: '[❗] Maaf kak kamu bukan owner ❌',
					ownerB: '[❗] Maaf kak kamu bukan owner ❌',
					userB: `──「 DAFTAR 」──\nHalo Kak !\nMaaf Kak Kamu belum Terdaftar Sebagai Teman mirai Daftar Untuk Berteman Dengan mirai dengam cara, \n\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar mirai|17\n\n──「 mirai chan 」──`,
					admin: '[❗] Maaf kak, kakak bukan admin jadi gabisa ❌',
					Badmin: ' [❗] Maaf kak mirai bukan admin jadi gabisa ❌',
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["6285890216240@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"6285890216240@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["6285890216240@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["6285890216240@s.whatsapp.net"]//ubah nomor lo
			const premium = ["6285890216240@s.whatsapp.net","6285890216240@s.whatsapp.net"]
       ...
       //function leveling
			...
			switch(command) {
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, test(), text, { quoted: mek })
					break
			       ...
			       case 'valxlove':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT mirai ✨* 」\n*│+wa.me/6285890216240*╰──────*「 *mirai* 」*────*\n\n*_JIKA INGIN MENJADI ADMIN  mirai_*\n*_Ketik /iklan_*' })
					break
					case 'premiumcek':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					sa = await getBuffer(`https://i.ibb.co/PcQ6tsB/79ac87b9358c.jpg`)
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/6285890216240*╰──────*「 * mirai* 」*────*\n\n*_JIKA INGIN MENJADI PREMIUM USER  mirai_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
 
					if (!isUser) return reply(mess.only.userB)
					if (isBanned) return reply(mess.only.benned)  
                 if (!ismod) return reply('kamu Belum Terdaftar sebagai User Mod')
                reply('kamu udah ke daftar sebagai user Mod')
                break
                    case 'modbotlist':
            ...
            break
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute1 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute2 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute3 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute4 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute5 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute6 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
				   ...
				   if (!isUser) return reply(mess.only.userB)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute7 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute8 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute9 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute10 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute12 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute11 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute13 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute14 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute15 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute16 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute17 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute18 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute19 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute20 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute21 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute22 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute23 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
					...
					if (!isUser) return reply(mess.only.userB)
					if (!isPremium) return reply('Anda bukan Member Premium, silakan hubungi owner atau ketik *#daftarvip* untuk membeli akses Premium!' ,text, { quoted: mek })
					qute24 = await getBuffer(`https://i.ibb.co/9Z18D0F/original.png`)
	...
	break
                ...
                case 'irii':
			client.sendMessage(from, './lindy/iri2.mp3', id)
			break
		case 'iri':
            ...
            case 'onichan':
            case 'bodoh':
                client.sendMessage(from, './lindy/baka.mp3',{mimetype: `audio/mpeg`, quoted: mek, ptt:true})
                break
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*ovo/dana :* _085890216240_\n', text, { quoted: mek })
					break
                case 'ttp':
                if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
 ...
 if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				 data = fs.readFileSync('./src/miraijokes.js');
                 jsonData = JSON.parse(data);
                 randIndex = Math.floor(Math.random() * jsonData.length);
                 randKey = jsonData[randIndex];
                hasil = await getBuffer(randKey.result)
                client.sendMessage(hasil, image, mek, '\`\`\`miraiJOKES\`\`\`')
				break
					case 'kata':
 ...
 if (!isOwner) return reply(mess.only.ownerB)
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘  mirai BOT 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ * mirai Broadcast* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
	...
	.then(() => {client.sendMessage(from, options, text)})
				...
				//frendowner
				case `addadmin`:
                   if (!isOwner) return reply('Perintah ini hanya bisa di gunakan oleh Owner mirai!', id)
                   for (let i = 0; i < mentionedJidList.length; i++) {
                   adminNumber.push(mentionedJidList[i])
                   fs.writeFileSync('./lib/database/admin.json', JSON.stringify(adminNumber))
                   reply('Success Menambahkan Admin mirai!')
				   }
                   break
				case 'wait':
				if (isBanned) return reply(mess.only.benned)    
